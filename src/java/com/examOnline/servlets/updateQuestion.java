...
//                  out.println("<body>");
                  try {
                        ...
                        boolean ans = dao.updateQuestion(qid, question, option1, option2, option3, option4, answer);
                        HttpSession s = request.getSession();
                        if (ans) {
                              out.println("done");
                              Message msg = new Message("Question details updated...", "success ", " bg-green-100 rounded-lg py-5 px-6 mb-4 text-base text-green-700 mb-3");
